    ...
    <ErrorBoundary>
      <div className='min-h-screen p-8 bg-gray-50 dark:bg-gray-900'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          <Link href="/examples/graph-network" className='block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md'>
          ...
          <Link href="/examples/neural-path" className='block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md'>
